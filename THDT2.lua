...
toggleButton.Text = "NPC Camlock: nek"
...
toggleHitboxButton.Text = "NPC Hitbox đây"
...
toggleButton.MouseButton1Click:Connect(function()
    ...
    if camlockEnabled then
        toggleButton.Text = "NPC Camlock: bật rùi nè ní"
        startCamlock()
    else
        toggleButton.Text = "NPC Camlock: tắt rùi ní"
        stopCamlock()
    end
end)
...
toggleHitboxButton.MouseButton1Click:Connect(function()
    ...
    if hitboxToggleEnabled then
        toggleHitboxButton.Text = "NPC Hitbox: bật rùi nè ní"
    else
        toggleHitboxButton.Text = "NPC Hitbox: tắt rùi ní"
    end
    updateAllNPCsHitbox()
end)
